...
%%%%2013-01-10 by Simeon Knieling
   ...
   for d=1:length(depth)
       depthCount=depthCount+1;
        ...
        figure; plot(-microElectrode(1).FIT);
        figure; plot(microElectrode(1).MA);
        figure; plot(microElectrode(1).RMS);
        figure; plot(microElectrode(1).STD);
        figure; plot(microElectrode(1).SPC);
        figure; plot(-macroElectrode(1).FIT);
        figure; plot(macroElectrode(1).MA);
        figure; plot(macroElectrode(1).RMS);
        figure; plot(macroElectrode(1).STD);
        figure; plot(macroElectrode(1).SPC);
